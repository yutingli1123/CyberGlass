...
// BLE Service for Image Transfer (separate from WiFi provisioning service)
#define BLE_IMAGE_SERVICE_UUID "c6116a0a-b7a0-11f0-880d-6baf85e562fd"
...
private:
  // BLE Image Transfer Service (separate from WiFi service)
  BLEService *pImageService;
